 ...
 * Configuration:
 *
 * Deviation = 20.629883 // DEVIATN.DEVIATION_M = 5 & DEVIATN.DEVIATION_E = 3
 * Base frequency = 432.999817 // FREQ2 = 10  & FREQ1 = A7 & FREQ0 = 62
 * Carrier frequency = 432.999817 // f_base + CHAN*delta_f_channel
 * Channel spacing = 199.951172  // MDMCFG0.CHANSPC_M = 248 & MDMCFG1.CHANSPC_E = 2
 * Data rate = 38.3835 Kbps // MDMCFG3.DRATE_M = 131 & MDMCFG4.DRATE_E = 10
 * RX filter BW = 101.562500 // MDMCFG4.CHANBW_M = 0 & MDMCFG4.CHANBW_E = 3
 * Channel number = 0 // CHANNR.CHAN = 0
 * Modulated = true 
 * Modulation format = GFSK  //MDMCFG2.MOD_FORMAT = 0b-001----
 * Manchester enable = false //MDMCFG2.ANCHESTER_EN  = 0b----0---
 * Data whitening = off //PKTCTRL0.WHITE_DATA = 0b-0------
 * Sync word qualifier mode = 30/32 sync word bits detected  // MDMCFG2.SYNC_MODE = 0b-----011
 * Preamble count = 4  //  MDMCFG1.NUM_PREAMBLE = 0b-010----
 * Packet format = Normal mode // PKTCTRL0.PKT_FORMAT = 0b--00---- 
 * Length config = Variable packet length mode. Packet length configured by the first byte after sync word 
 * CRC enable = true // PKTCTRL0.CRC_EN = 0b-----1--
 * Packet length = 60 // PKTLEN = 0x3C
 * Device address = 1 // 
...
#define CC1101_DEFVAL_PKTLEN     0x3D        // Packet Length. Real default = 0xFF
#define CC1101_DEFVAL_PKTCTRL1   0x06        // Packet Automation Control
#define CC1101_DEFVAL_PKTCTRL0   0x05        // Packet Automation Control. Real default = 0x45
#define CC1101_DEFVAL_ADDR       0xFF        // Device Address. Real default = 0x00
#define CC1101_DEFVAL_CHANNR     0x00        // Channel Number. Real default = 0x00
...
//#define CC1101_DEFVAL_MDMCFG4  0xCA        // Modem Configuration. Real default = 0x8C
#define CC1101_DEFVAL_MDMCFG3    0x83        // Modem Configuration. Real default = 0x22
#define CC1101_DEFVAL_MDMCFG2    0x93        // Modem Configuration. Real default = 0x02
#define CC1101_DEFVAL_MDMCFG1    0x22        // Modem Configuration. Real default = 0x22
#define CC1101_DEFVAL_MDMCFG0    0xF8        // Modem Configuration. Real default = 0xF8
#define CC1101_DEFVAL_DEVIATN    0x35        // Modem Deviation Setting. Real default = 0x47
